...
name = 'seven_pipe_3_reach'
name_moc='moc_simulation_results'
namef = 'PINN_7_pipes_three_reach'
nPipes=7
M_h = 19  # Number of nodes
M_p = 21  # Number of pipes
tlen = 4000
t = np.linspace(0, 5, tlen)
ind_obs = [0, 3]  # observation points, at node 1 and node 4
demand_node=2
X = np.load(name_moc+'.npy').T
